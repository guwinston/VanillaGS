...
import time
from vanilla_gaussian_splatting_with_tcgs import rasterize_gaussians, mark_visible
...
class Rasterizer(nn.Module):
    ...
    def forward(self, camera, background):
        ...
        # }, r"D:\code\TCGS\output\test/tcgs_gs1.pth")
...
def render_scene(gaussian_path, camera_path, save_path=None, sh_degree=3, test_idx=None):
    ...
    plt.plot(times, label="Render time of TCGS")
    plt.xlabel("Frame")
    plt.ylabel("Time cost (ms)")
    plt.title("Render time of TCGS")
    plt.legend()
    plt.show()
...
if __name__ == "__main__":
    scenes = {
        "garden": {
            ...
            "save_path": r"output/garden/tcgs"
        },
        "mc_aerial_c36": {
            ...
            "save_path": r"output/mc_aerial_c36/tcgs"
        },
        "DP1258_dji_and_yy": {
            ...
            "save_path": r"output/DP1258_dji_and_yy/tcgs"
        },
        "DP1139": {
            ...
            "save_path": r"output/DP1139/tcgs"
        },
        "37009-47004": {
            ...
            "save_path": r"output/37009-47004/tcgs",
        }
    }
    ...
    with measure_gpu_memory("tcgs rendering"):
